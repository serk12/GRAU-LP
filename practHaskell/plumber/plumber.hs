...
printResult equal [] = putStr $ "qtty test equals: " ++ (show equal) ++ "\n"

printResult equal (((out1,mem1),(out2,mem2)):xs) = do 
  putStr $ "output code1: " ++ show out1 ++ "\noutput code2: " ++ (show out2) ++ "\n"
  putStr $ "diff in memory: " ++ show (comparate mem1 mem2) ++ "\n"
  if out1 == out2
       ...
       "0" -> do
              ...
              case typeTest of
                   "0" -> do
                          ...
                          inputs <- readInputs
                          case typeMem of
                               "0"  -> printResult 0 $ runAndCompareK (interpretCommand (start::MemoryList Integer)) (read code1::(Command Integer)) (read code2::(Command Integer)) ((map readInt inputs) ++ infini) 1
                               "1"  -> printResult 0 $ runAndCompareK (interpretCommand (start::MemoryTree Integer)) (read code1::(Command Integer)) (read code2::(Command Integer)) ((map readInt inputs) ++ infini) 1
                   "1" -> do
                          putStr "Qtty test? \n"
                          k <- getLine
                          case typeMem of
       ...
       "1" -> do
              ...
              case typeTest of
                   "0" -> do
                          ...
                          inputs <- readInputs
                          case typeMem of
                               "0"  -> printResult 0 $ runAndCompareK (interpretCommand (start::MemoryList Float)) (read code1::(Command Float)) (read code2::(Command Float)) ((map readFloat inputs) ++ infini) 1
                               "1"  -> printResult 0 $ runAndCompareK (interpretCommand (start::MemoryTree Float)) (read code1::(Command Float)) (read code2::(Command Float)) ((map readFloat inputs) ++ infini) 1
                   "1" -> do
                          putStr "Qtty test? "
                          k <- getLine
                          case typeMem of
